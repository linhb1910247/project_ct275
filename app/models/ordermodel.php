    ...
    class ordermodel extends Dmodel {
       public function __construct(){
        ...
        public function list_order($table_order){
            $sql="SELECT * FROM $table_order ORDER BY order_code DESC";    
        ...
        public function ordercetailscustomerbyid($table_order,$table_product,$table_order_details,$cond){
            $sql="SELECT * FROM  $table_order,$table_order_details,$table_product WHERE $cond ";    
            return $this->db->select($sql);
        }
